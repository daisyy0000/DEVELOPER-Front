...
$(() => {
    ...
    $.ajax({
        ...
        success: function (list) {
            ...
            $(list).each((index, item) => {
                ...
                if (item.usersDTO.name == null) {
                   $copy.find('div#reservation-name').html('호스트가 예약한 건.')
                   $copy.find('div#reservation-name').css('color', '#FF6D5A')
    ...
    $('#content-wrap > div.hostpage-body-wrap > div.content-container > div.info-title > input[type=button]').click((e) => {
